/* Celem zadania jest przećwiczenie dziedziczenia wielokrotnego. 
  ...
  w grze (w sumie jest to sześć klas). Jeśli pozwoli to Państwu 
  zaoszczędzić czas, dozwolone jest umieszczenie całego kodu 
  w jednym pliku .h oraz jednym .cpp (poza main.cpp).

  Proszę na podstawie oczekiwanego outputu wywnioskować, jaka jest
  hierarchia klas oraz dopisać niezbędne funkcje. W dokumentacji 
  proszę uzasadnić hierarchię (bez tego dokumentacja nieważna).*/
